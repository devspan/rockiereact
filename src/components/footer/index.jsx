  ...
  const [listSocial] = useState([
    {
      ...
      path: "https://www.facebook.com/ultronexchange",
    },
    {
      icon: "fab fa-instagram",
      path: "https://www.instagram.com/ultronexchange/",
    },
    { icon: "fab fa-youtube", path: "https://www.youtube.com/ultronexchange" },
    { icon: "fab fa-twitter", path: "https://twitter.com/ultronexchange" },
    { icon: "fab fa-telegram", path: "https://t.me/ultronexchange" },
  ]);
    ...
    <footer className="footer style-2">
      ...
      <div className="container-fluid">
        <div className="footer__bottom">
          <p>
            ©2024 Ultronxchange.io All rights reserved. Terms of Service |
            Privacy Terms
          </p>
        </div>
      </div>
